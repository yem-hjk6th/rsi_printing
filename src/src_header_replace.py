...
INPUT_SRC = r"C:\Users\888y9\Desktop\rsi_printing\build\Roboter\src\Ye_RSI_t2.src"
...
# Number of leading cartesian PTPs to skip (PRC safe approach points)
SKIP_FIRST_PTP = 1
