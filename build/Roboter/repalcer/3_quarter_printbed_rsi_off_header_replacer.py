"""
3_quarter_printbed_rsi_off_header_replacer.py
Extract motion commands from PRC-generated .src, replace header/footer with
KRL structure for KRC — open-loop version (no RSI).
...
INPUT_SRC  = r"C:\Users\888y9\Desktop\rsi_printing\build\Roboter\ori\Ye_micro_t1.src"
OUTPUT_SRC = r"C:\Users\888y9\Desktop\rsi_printing\build\Roboter\src\Ye_micro_t1_fixed.src"          # None = auto _fixed.src in same dir
PROG_NAME  = "Ye_RSI_t6"
EXTRUDER_RPM = 400
...
def extract_moves(src_path):
    ...
    with open(src_path, "r", encoding="utf-8") as f:
        ...
        for line in f:
            ...
            if re.match(r"^DECL\s", stripped):     continue
            if re.match(r"^PelletExtruder", stripped): continue
