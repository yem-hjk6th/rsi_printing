...
def main() -> None:
    ...
    parser.add_argument("--out", type=str, default="sync_robot_aruco.csv")

    parser.add_argument("--camera-source", type=int, default=0)
    parser.add_argument("--use-zed", action="store_true")
    parser.add_argument("--zed-resolution", type=str, default="HD2K")
    parser.add_argument("--zed-fps", type=int, default=15)
    parser.add_argument("--zed-depth-mode", type=str, default="NEURAL")
    parser.add_argument("--zed-units", type=str, default="MILLIMETER")
    ...
    parser.add_argument("--tracked-marker-ids", type=str, default="0,1,2,3,4")
    parser.add_argument("--min-markers", type=int, default=3)

    parser.add_argument("--max-cam-lag-ms", type=float, default=120.0)
    parser.add_argument("--capture-interval-s", type=float, default=0.8)
    parser.add_argument("--stable-time-s", type=float, default=0.25)
    parser.add_argument("--stable-pos-mm", type=float, default=0.3)
    parser.add_argument("--stable-ang-deg", type=float, default=0.2)
